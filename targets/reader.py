"""
RTF target-list reader – extracts IPv4, IPv6, CIDR, URL and hostname
assets from an RTF (or plain-text) file.
"""
...
def extract_targets(text: str) -> List[TargetAsset]:
    """Return deduplicated TargetAsset list extracted from *text*."""
    seen: set = set()
